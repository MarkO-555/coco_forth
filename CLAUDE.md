...
| Library word — full reference (description, prose, examples)     | `docs/reference.html` § (matching .fs file)           |
| Library word — quick index (does this exist? which file? stack?) | `lib/README.md` (auto-generated by `tools/gen-lib-readme.py`) |
| fc.py syntax / directives (CONSTANT, +FIELD, DATA[PY], CODE)     | `tools/README.md`, `docs/reference.html` § Compiler |
